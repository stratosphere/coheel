...
public final class WikipediaTokenizer extends Tokenizer {
	...
	private Iterator<State> tokens = null;
	...
	public final boolean incrementToken() throws IOException {
		...
		if (tokenOutput == TOKENS_ONLY || !untokenizedTypes.contains(type)) {
			setupToken();
		} else if (tokenOutput == UNTOKENIZED_ONLY && untokenizedTypes.contains(type)) {
		...
		flagsAtt.setFlags(scanner.stateCount());
		first = false;
		return true;
	}
